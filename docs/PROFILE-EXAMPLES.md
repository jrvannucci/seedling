...
- [A research group](#a-research-group) — Spyder, separate collection and
  analysis environments
- [A software team](#a-software-team) — VS Code, repos cloned and installed
- [A mixed team](#a-mixed-team) — both editors, one standard
- [A classroom](#a-classroom) — identical machines, pinned, nothing extra
- [A restricted corporate network](#a-restricted-corporate-network) — no
  public internet, but internal mirrors
- [An internal PyPI, and nothing else](#an-internal-pypi-and-nothing-else) —
  a partial bundle, mixed sources
- [An air-gapped deployment](#an-air-gapped-deployment) — openly licensed,
  no internet
- [An air-gapped deployment, with Marketplace rights](#an-air-gapped-deployment-with-marketplace-rights)
  — official VS Code and Pylance
- [Everything, air-gapped](#everything-air-gapped) — every offline capability
  in one deployment
- [Just Python](#just-python) — no editor at all
